 ...
 */
public class ListAdapterForHolidays extends BaseAdapter {
    ...
    public ListAdapterForHolidays(Activity activity, List<Data> dataItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.card_view_for_latest_holidays, null);
