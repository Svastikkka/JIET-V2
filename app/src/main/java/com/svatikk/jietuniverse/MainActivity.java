...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Latest happening");
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri uri =Uri.parse("https://www.facebook.com/jietadmission17");
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("https://www.youtube.com/channel/UC9oG_6rLrDteh534LfeV4Lw?spfreload=10"));
                startActivity(intent);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.introduction) {
            ...
            intent.setData(Uri.parse("geo:26.148967,73.046504"));
            ...
            // Handle the camera action
            Intent intent = new Intent(getApplicationContext(),ContactNumbers.class);
            startActivity(intent);
