 ...
 */
public class ListAdapterForAboutUs extends BaseAdapter {
    ...
    public ListAdapterForAboutUs(Activity activity, List<Data> dataItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.card_view_for_contact_numbers, null);
